package br.com.vithorfjm.lojastore.infra.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.PUT, "/product")).hasRole("ADMIN")
                        .requestMatchers(AntPathRequestMatcher.antMatcher(HttpMethod.DELETE, "/product")).hasRole("ADMIN")
